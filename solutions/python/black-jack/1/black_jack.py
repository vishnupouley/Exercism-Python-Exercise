...
def value_of_card(card, ace=False):
    ...
    """
    tens = ['K', 'Q', 'J', '10']
    if any(card == ten for ten in tens):
        return 10
    elif card == 'A':
        if ace:
            return 11
...
def value_of_ace(card_one, card_two):
    ...
    ace_value = 21 - total_value
    if ace_value >= 11:
        if card_one == 'A' or card_two == 'A':
            if card_one_value == 10 or card_two_value == 10 or card_one_value == 1 or card_two_value == 1:
                return 1
            else:
                return 11
        else:
...
def is_blackjack(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    if card_one or card_two == 'A':
        card_one_value = value_of_card(card_one, ace=True)
        card_two_value = value_of_card(card_two, ace=True)
...
if __name__ == "__main__":
    ...
    for variant, (card_one, card_two, ace_value) in enumerate(test_data, 1):
        print(card_one, card_two, ace_value)
